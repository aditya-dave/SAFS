...
public class FriendRequestFragmentAdapter extends RecyclerView.Adapter<FriendRequestFragmentAdapter.MyViewHolder>{
    ...
    public FriendRequestFragmentAdapter(Context mContext, ArrayList<UserAccountSettings> data, CustomItemClickListener listener) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public CoordinatorLayout item_friendrequests;
        ...
        public MyViewHolder(final View itemView) {
            super(itemView);
            item_friendrequests = (CoordinatorLayout) itemView.findViewById(R.id.item_friendrequests);
    ...
    @Override
    public FriendRequestFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                        int viewType) {
        // create a new view
        View view =  LayoutInflater.from(parent.getContext())
                .inflate(R.layout.layout_friendrequests_listitem, parent, false);
