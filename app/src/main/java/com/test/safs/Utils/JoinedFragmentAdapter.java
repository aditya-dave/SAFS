...
public class JoinedFragmentAdapter extends RecyclerView.Adapter<JoinedFragmentAdapter.MyViewHolder>{
    ...
    public JoinedFragmentAdapter(Context mContext, ArrayList<Activity> data, CustomItemClickListener listener) {
    ...
    @Override
    public JoinedFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                 int viewType) {
        // create a new view
