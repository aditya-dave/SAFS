...
public class FindUsersFragmentAdapter extends RecyclerView.Adapter<FindUsersFragmentAdapter.MyViewHolder>{
    ...
    public FindUsersFragmentAdapter(Context mContext, ArrayList<UserAccountSettings> data, CustomItemClickListener listener) {
    ...
    public static class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public CoordinatorLayout item_findusers;
        ...
        public MyViewHolder(final View itemView) {
            super(itemView);
            item_findusers = (CoordinatorLayout) itemView.findViewById(R.id.item_findusers);
    ...
    @Override
    public FindUsersFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                int viewType) {
        // create a new view
