...
public class CreatedFragmentAdapter extends RecyclerView.Adapter<CreatedFragmentAdapter.MyViewHolder>{
    ...
    public CreatedFragmentAdapter(Context mContext, ArrayList<Activity> data, CustomItemClickListener listener) {
    ...
    @Override
    public CreatedFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                  int viewType) {
        // create a new view
