...
public class FriendsFragmentAdapter extends RecyclerView.Adapter<FriendsFragmentAdapter.MyViewHolder>{
    ...
    public FriendsFragmentAdapter(Context mContext, ArrayList<Activity> data, CustomItemClickListener listener) {
    ...
    @Override
    public FriendsFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                                  int viewType) {
        // create a new view
